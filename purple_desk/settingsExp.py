...
## (Optional but recommended) Add simple JWT settings
...
#         'ENGINE': 'django.db.backends.mysql',
#         'NAME': 'purple_desk_db',      # your database name
#         'USER': 'skyzone_cms_user',                # your MySQL username
#         'PASSWORD': 'kQs88iKfmKtprgnocTkokbmiLWms0SSN',   # your MySQL password
#         'HOST': 'dpg-d4ines0dl3ps73dbrpjg-a',           # or 'localhost'
