...
class RentalFacility(models.Model):
    ...
    rental_group_name = models.CharField(max_length=255, blank=True, null=True)
    ...
    maximum_jumpers = models.IntegerField()
...
# Rental_jumper_group	rental_group_name	per_jumper_price	Minimum_jumpers	maximum_jumpers	inclusions