...
#     external_id = models.CharField(max_length=255, blank=True, null=True)  # Add this
...
# models.py - RollerBookingDetails model update
...
class RollerBookingDetails(models.Model):
    ...
    # Rename deposit_made to deposit_made_in_doller (corrected spelling)
    deposit_made_in_doller = models.FloatField(blank=True, null=True)
    ...
    # Add roller_booking_id field to store Roller's booking ID
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=['is_booking_paid']),
        ]
