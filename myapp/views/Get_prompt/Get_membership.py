...
#             'parent_addon_price': float(membership_obj.parent_addon_price) if membership_obj.parent_addon_price else "",
...
#     result = await extract_membership_info(df, schedule_with_dict)
...
#             if popular['pitch_introduction']:
#                 output_lines.append(f"Pitch: {popular['pitch_introduction']}")
#             if popular['features']:
...
#                 if membership_item['pitch_introduction']:
...
#                 subscription_note = f" ({membership_item['subscription']})" if membership_item['subscription'] else ""
#                 output_lines.append(f"  - {membership_item['title']}{subscription_note}: {membership_item['activity_time']} - ${membership_item['price']}")
...
#                 output_lines.append(f"  - {membership_item['title']}: {membership_item['activity_time']} - ${membership_item['price']}")
